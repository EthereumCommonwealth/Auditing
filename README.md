...
Only the first audit of a smart-contract code for a month is free. If a customer submits an updated smart-contract for re-audit earlier than a month after the previous audit was completed, then it will be necessary to pay for the re-audit ($0,6 per line of code).
